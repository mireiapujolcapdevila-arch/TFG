...
ax1.plot(sol_l.y[0], sol_l.y[1], 'b-', linewidth=2, label='Branca baixa (Esquerra)')
ax1.plot(sol_r.y[0], sol_r.y[1], 'r-', linewidth=2, label='Branca alta (Dreta)')
...
axs2[0].plot(xi_l, sol_l.y[0], 'b-', linewidth=2, label='Branca baixa')
axs2[0].plot(xi_r, sol_r.y[0], 'r-', linewidth=2, label='Branca alta')
axs2[0].axvline(x=0.0, color='g', linestyle='--', label='Punt de salt (z = 2)')
axs2[0].axhline(y=2.0, color='gray', linestyle=':')
...
axs2[1].plot(xi_l, sol_l.y[1], 'b-', linewidth=2, label='Branca baixa')
axs2[1].plot(xi_r, sol_r.y[1], 'r-', linewidth=2, label='Branca alta')
